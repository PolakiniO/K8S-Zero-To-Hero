...
### Manifests
- `k8s/LabPack/week1/lab3/lab3-memhog.yaml`
- `k8s/LabPack/week1/lab3/lab3-memhog-fix.yaml`
...
### Manifests
- `k8s/LabPack/week1/lab4/lab4-broken-liveness-probe.yaml`
- `k8s/LabPack/week1/lab4/lab4-broken-readiness-probe.yaml`
- `k8s/LabPack/week1/lab4/lab4-fix-liveness-probe.yaml`
- `k8s/LabPack/week1/lab4/lab4-readiness-service.yaml`
...
### Manifests
- `k8s/LabPack/week1/lab5/lab5-configmap-env-vars.yaml`
- `k8s/LabPack/week1/lab5/lab5-configmap-broken-env-vars.yaml`
- Reuse `k8s/LabPack/week1/lab5/lab5-configmap-env-vars.yaml` as the fix manifest.
