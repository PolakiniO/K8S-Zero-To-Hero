...
- `k8s/LabPack/week1/`: Canonical runnable manifests for each lab scenario (outside this folder).
...
### Lab 2 — RBAC
- `k8s/LabPack/week1/lab2/lab2-rbac-fix.yaml`

### Lab 3 — OOMKilled
- `k8s/LabPack/week1/lab3/lab3-memhog.yaml` (intentionally constrained)
- `k8s/LabPack/week1/lab3/lab3-memhog-fix.yaml` (right-sized memory limit)

### Lab 4 — Probes
- `k8s/LabPack/week1/lab4/lab4-broken-liveness-probe.yaml` (broken liveness path)
- `k8s/LabPack/week1/lab4/lab4-broken-readiness-probe.yaml` (broken readiness path)
- `k8s/LabPack/week1/lab4/lab4-fix-liveness-probe.yaml` (healthy liveness/readiness)
- `k8s/LabPack/week1/lab4/lab4-readiness-service.yaml` (service for readiness testing)

### Lab 5 — ConfigMap/Secret
- `k8s/LabPack/week1/lab5/lab5-configmap-env-vars.yaml` (healthy baseline and fix manifest)
- `k8s/LabPack/week1/lab5/lab5-configmap-broken-env-vars.yaml` (intentional secret typo)
...
```bash
kubectl apply -f k8s/LabPack/week1/lab2/lab2-rbac-fix.yaml
...
```bash
kubectl apply -f k8s/LabPack/week1/lab3/lab3-memhog.yaml
...
kubectl apply -f k8s/LabPack/week1/lab3/lab3-memhog-fix.yaml
kubectl get pod memhog -w
kubectl top pod memhog -n week1
```
...
```bash
kubectl apply -f k8s/LabPack/week1/lab4/lab4-broken-liveness-probe.yaml
...
kubectl apply -f k8s/LabPack/week1/lab4/lab4-fix-liveness-probe.yaml
kubectl get pod probe-demo -w
kubectl describe pod probe-demo
```
...
```bash
kubectl apply -f k8s/LabPack/week1/lab4/lab4-readiness-service.yaml
...
```bash
kubectl delete pod probe-demo
kubectl apply -f k8s/LabPack/week1/lab4/lab4-broken-readiness-probe.yaml
kubectl get pod probe-demo -w
kubectl describe pod probe-demo
kubectl get endpoints probe-svc -w
```
...
```bash
kubectl apply -f k8s/LabPack/week1/lab5/lab5-configmap-env-vars.yaml
...
kubectl apply -f k8s/LabPack/week1/lab5/lab5-configmap-broken-env-vars.yaml
kubectl get pod cfg-demo -w
kubectl describe pod cfg-demo
kubectl logs cfg-demo
```
